...
def deviazione_adtv_giorni():
    dev_adtv=[0 for x in range(5)]
    for i in range(5,len(df1)):
        dev_value_adtv2 = (math.sqrt((df1['Volume'].iloc[i] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-1] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-2] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-3] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-4] - df1['ADTV'].iloc[i])**2)/5)*2
        dev_value_adtv5 = (math.sqrt((df1['Volume'].iloc[i] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-1] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-2] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-3] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-4] - df1['ADTV'].iloc[i])**2)/5)*5
        dev_value_adtv10 = (math.sqrt((df1['Volume'].iloc[i] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-1] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-2] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-3] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-4] - df1['ADTV'].iloc[i])**2)/5)*10
        dev_value_adtv20 = (math.sqrt((df1['Volume'].iloc[i] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-1] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-2] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-3] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-4] - df1['ADTV'].iloc[i])**2)/5)*20
        dev_value_adtv50 = (math.sqrt((df1['Volume'].iloc[i] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-1] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-2] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-3] - df1['ADTV'].iloc[i])**2 + (df1['Volume'].iloc[i-4] - df1['ADTV'].iloc[i])**2)/5)*50
        ...
        dev_adtv.append(dev_value_adtv_int_2)
        dev_adtv.append(dev_value_adtv_int_5)
        dev_adtv.append(dev_value_adtv_int_10)
        dev_adtv.append(dev_value_adtv_int_20)
        dev_adtv.append(dev_value_adtv_int_50)
    df2["ADTV std 2 Giorni"] = pd.Series(dev_adtv)
    df2["ADTV std 5 Giorni"] = pd.Series(dev_adtv)
    df2["ADTV std 10 Giorni"] = pd.Series(dev_adtv)
    df2["ADTV std 20 Giorni"] = pd.Series(dev_adtv)
    df2["ADTV std 50 Giorni"] = pd.Series(dev_adtv)
